...
var mainNetProvider = new WalletProvider(mainNetWallet, 'https://mainnet.infura.io/v3/xxx');
...
var ropstenProvider = new WalletProvider(ropstenWallet, 'https://ropsten.infura.io/v3/xxx');
